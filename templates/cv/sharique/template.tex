...
%% Recreated in LaTeX from an HTML/CSS resume export (photo header, blue
%% accent bar, two-column skills/certs grid, highlighted award callout).
...
\begin{minipage}[t]{0.80\linewidth}
  ...
  {\fontsize{8.5}{11}\selectfont\color{graytext}%
   ...
   \href{[YOUR_GITHUB_URL]}{\color{accent}[YOUR_GITHUB_DISPLAY]} \quad
   [YOUR_WORK_AUTH_NOTE]}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\linewidth}
  \raggedleft
  \begin{tikzpicture}
    \clip[rounded corners=1.5pt] (0,0) rectangle (2.1cm,2.1cm);
    \node[anchor=south west,inner sep=0] at (0,0)
      {\includegraphics[width=2.1cm,height=2.1cm]{[YOUR_PHOTO]}};
  \end{tikzpicture}
\end{minipage}
...
{\fontsize{9}{11}\selectfont\bfseries [SKILL_CATEGORY_1]}\par
{\fontsize{8.5}{11}\selectfont\color{graytext}[SKILL_ITEMS_1]}
&
{\fontsize{9}{11}\selectfont\bfseries [SKILL_CATEGORY_2]}\par
{\fontsize{8.5}{11}\selectfont\color{graytext}[SKILL_ITEMS_2]}
\\[8pt]
{\fontsize{9}{11}\selectfont\bfseries [SKILL_CATEGORY_3]}\par
{\fontsize{8.5}{11}\selectfont\color{graytext}[SKILL_ITEMS_3]}
&
{\fontsize{9}{11}\selectfont\bfseries [SKILL_CATEGORY_4]}\par
{\fontsize{8.5}{11}\selectfont\color{graytext}[SKILL_ITEMS_4]}
\end{tabularx}
...
\begin{tabularx}{\linewidth}{@{}X X@{}}
{\fontsize{9}{11}\selectfont \href{[CERT_URL_1]}{\color{darktext}[CERT_NAME_1]}}\par
{\fontsize{8.5}{10}\selectfont\color{graytext}[CERT_DATE_1]}
&
{\fontsize{9}{11}\selectfont [CERT_NAME_2]}\par
{\fontsize{8.5}{10}\selectfont\color{graytext}[CERT_DATE_2]}
\end{tabularx}
...
\entryrow{[PROJECT_NAME]}{[PROJECT_START]~--~[PROJECT_END]}
\begin{compactitem}
  \item [BULLET]
  \item [BULLET]
\end{compactitem}
...
{\fontsize{9}{11}\selectfont\bfseries [LANGUAGE_1]}\ {\fontsize{8.5}{10}\selectfont\color{graytext}([LEVEL_1])}\qquad
{\fontsize{9}{11}\selectfont\bfseries [LANGUAGE_2]}\ {\fontsize{8.5}{10}\selectfont\color{graytext}([LEVEL_2])}\qquad
{\fontsize{9}{11}\selectfont\bfseries [LANGUAGE_3]}\ {\fontsize{8.5}{10}\selectfont\color{graytext}([LEVEL_3])}
